...
export const HABITS: Habit[] = [
  ...
  { id: "knee_am",     label: "Knee Flossing AM",       category: "recovery",  icon: "🦵",  description: "Start with 20, no hands until failure (at least 50)" },
  { id: "knee_pm",     label: "Knee Flossing PM",       category: "recovery",  icon: "🦵",  description: "Start with 20, no hands until failure (at least 50)" },
